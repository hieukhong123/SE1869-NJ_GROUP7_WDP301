...
const Dashboard = () => {
    ...
    if (error)
        return (
            <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4 bg-transparent">
                <p className="text-red-500 font-serif text-xl">Unable to load dashboard</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                    ...
                    <div className="bg-white p-6 border border-gray-100 rounded-sm shadow-sm flex flex-col justify-between group">
                        <div className="flex justify-between items-start mb-6">
                            <div>
                                <p className="text-[10px] uppercase tracking-widest text-gray-400 font-medium mb-1">Total Revenue</p>
                                <p className="text-xs text-green-600 font-medium flex items-center gap-1">
                                    <TrendUp size={12} /> +12% this month
                                </p>
                            </div>
                            <div className="w-10 h-10 flex items-center justify-center bg-orange-50 text-orange-800 rounded-sm group-hover:bg-orange-800 group-hover:text-white transition-colors duration-300">
                                <CurrencyDollar size={20} weight="light" />
                            </div>
                        </div>
                    ...
                    <div className="bg-white p-6 border border-gray-100 rounded-sm shadow-sm flex flex-col justify-between group">
                        <div className="flex justify-between items-start mb-6">
                            <div>
                                <p className="text-[10px] uppercase tracking-widest text-gray-400 font-medium mb-1">Total Reservations</p>
                            </div>
                    ...
                    <div className="bg-white p-6 border border-gray-100 rounded-sm shadow-sm flex flex-col justify-between group">
                        <div className="flex justify-between items-start mb-6">
                            <div>
                                <p className="text-[10px] uppercase tracking-widest text-gray-400 font-medium mb-1">Properties in Portfolio</p>
                            </div>
                            <div className="w-10 h-10 flex items-center justify-center bg-gray-50 text-gray-600 rounded-sm group-hover:bg-gray-900 group-hover:text-white transition-colors duration-300">
                    ...
                    <div className="bg-white p-6 border border-gray-100 rounded-sm shadow-sm flex flex-col justify-between group">
                        <div className="flex justify-between items-start mb-6">
                            <div>
                                <p className="text-[10px] uppercase tracking-widest text-gray-400 font-medium mb-1">Registered Guests</p>
                            </div>
                            <div className="w-10 h-10 flex items-center justify-center bg-gray-50 text-gray-600 rounded-sm group-hover:bg-gray-900 group-hover:text-white transition-colors duration-300">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white border border-gray-100 rounded-sm shadow-sm p-6 lg:p-8">
                        <div className="mb-6 flex items-center justify-between">
                            <div>
                                <h3 className="text-lg font-serif text-gray-900">Revenue Growth</h3>
                                <p className="text-[10px] uppercase tracking-widest text-gray-400 mt-1">Monthly Financial Analysis</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-white border border-gray-100 rounded-sm shadow-sm p-6 lg:p-8">
                        <div className="mb-6 flex items-center justify-between">
                            <div>
                                <h3 className="text-lg font-serif text-gray-900">Booking Distribution</h3>
                                <p className="text-[10px] uppercase tracking-widest text-gray-400 mt-1">Reservations by Current Status</p>
                            </div>
                        </div>
                        <div className="h-72 w-full">
